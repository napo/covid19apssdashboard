...
function preparedatatable() {
    ...
    $.each(datasituazionecomuni, function(index, row) {
        if (row.contagi > 0) {
            ...
            // rimuovi ic = addSymbolDiff(row.contagi - iericontagi);
            // rimuovi ig = addSymbolDiff(row.guariti - ieridimessi);
            // rimuovi id = addSymbolDiff(row.decessi - ieridecessi);
    ...
    $('#data-table th').each(function(index) {
        ...
        switch (index) {
            ...
            case 3:
                ...
                break;
            case 4:
                title = "Percentuale della popolazione contagiata dal 03/03/2020 "
                break;
            case 5:
